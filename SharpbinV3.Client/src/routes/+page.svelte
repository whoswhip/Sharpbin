...
<svelte:head>
	...
	<meta
		...
		content="Create and share code snippets, and text instantly with Sharpbin."
	/>
</svelte:head>
				...
				<div class="mt-1 flex">
					...
					<div
						...
						'markdown'
							...
							: 'w-full rounded-b'} border border-neutral-700 bg-neutral-800 p-1 pr-2 pl-2 text-sm text-neutral-400 md:h-8 md:min-h-8"
					>
